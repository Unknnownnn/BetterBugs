...
Crikket will generate path-style presigned upload URLs for custom non-AWS endpoints, for example:

```text
https://minio.example.com/crikket-production/organizations/...
```
